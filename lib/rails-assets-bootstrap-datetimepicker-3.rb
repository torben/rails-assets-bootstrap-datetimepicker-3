...
module RailsAssetsBootstrapDatetimepicker3
  ...
  def self.gem_spec
    Gem::Specification::load(
      gem_path.join("rails-assets-bootstrap-datetimepicker-3.gemspec").to_s
    )
  end
...
RailsAssets.components << RailsAssetsBootstrapDatetimepicker3
